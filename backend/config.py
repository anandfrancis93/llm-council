...
# Using exact OpenRouter model IDs (verify at openrouter.ai/models)
COUNCIL_MODELS = [
    "openai/gpt-4o",
    "anthropic/claude-3-5-sonnet",  # Note: dashes not dots
    "google/gemini-2.0-flash-001",  # Current working Gemini model
